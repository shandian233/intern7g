...
export default class LockOpen extends BaseClass{
	 ...
	 constructor( ani)
	{
		...
		this.in_speak=new XInput(GmPlay.xani_button);
	...
	ProcTouch( msg, x, y)
	{
		...
		if(this.btn_send.ProcTouch(msg, x, y))
		{
			...
			{//发送小喇叭内容
				...
				{///cx
					GmProtocol.gi().s_SetLock(1, 0, this.in_speak.sDetail);
					XStat.gi().PopStat(1);
				}
			}
		}
...
{
	XStat.gi().PushStat(XStat.GS_LOCKOPEN);
