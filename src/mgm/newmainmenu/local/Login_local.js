...
import Regist_local from "./Regist_local"

export default class Login_local  extends BaseClass{
...
//		GmPlay.xani_ui.DrawAnimaEx(offx+offw/2,20, "七国名", 0, 101, 1.0f*GmConfig.SCRW/800, 1.0f*GmConfig.SCRH/480, 0, 0, 0);
		...
		offy=200;
		GmPlay.xani_ui.DrawAnimaEx(offx-70,offy+55, "账号密码", 0, 101, 1.0, 1.0, 0, 0, 0);
		GmPlay.xani_ui.DrawAnimaEx(offx+30,offy+50, "账号密码", 2, 101, 1.0, 1.0, 0, 0, 0);
		...
		offy=300;
		GmPlay.xani_ui.DrawAnimaEx(offx-70,offy+55, "账号密码", 1, 101, 1.0, 1.0, 0, 0, 0);
		GmPlay.xani_ui.DrawAnimaEx(offx+30,offy+50, "账号密码", 2, 101, 1.0, 1.0, 0, 0, 0);
